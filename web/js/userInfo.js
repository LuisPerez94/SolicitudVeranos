...
function imprimirMaterias() {
    ...
    for (i = 0; i < alumnos.length; i++) {
        ...
        materias += "<tr class='success'><th>Nombre del Alumno </th><td>" + nombres[i] + "</td></tr>" + "<tr><th>Materia </th><td>" + materia1[i].replace("Semestre", "Semestre - ") +
...
var id = [];
    ...
    $("#lista").html(lista);
    $("#container-descarga").html('<button type="submit" class="btn btn-primary" id="descarga" form="form">Descargar Documento</button>');
